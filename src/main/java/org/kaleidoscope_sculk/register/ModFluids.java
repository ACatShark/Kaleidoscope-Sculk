...
public class ModFluids {
    ...
    public static final DeferredHolder<FluidType, JuiceFluidType> SCULK_DUST_JUICE_TYPE = FLUID_TYPES.register(
            "sculk_juice",
            () -> new JuiceFluidType(ResourceLocation.fromNamespaceAndPath(Kaleidoscope_sculk.MODID, "sculk_juice"), 0)
    );
    ...
    public static final DeferredHolder<Fluid, FlowingFluid> SCULK_JUICE =
            FLUIDS.register("sculk_juice", () -> new BaseFlowingFluid.Source(makeProperties()));

    public static final DeferredHolder<Fluid, FlowingFluid> SCULK_DUST_JUICE_FLOWING =
            FLUIDS.register("sculk_juice_flowing", () -> new BaseFlowingFluid.Flowing(makeProperties()));
